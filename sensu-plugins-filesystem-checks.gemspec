...
require_relative 'lib/sensu-plugins-filesystem-checks'
...
Gem::Specification.new do |s|
  ...
  s.homepage               = 'https://github.com/sensu-plugins/sensu-plugins-filesystem-checks'
  s.license                = 'MIT'
  ...
  s.name                   = 'sensu-plugins-filesystem-checks'
